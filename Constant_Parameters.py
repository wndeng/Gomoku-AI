...
MCTS_SIMULATION_COUNT = 5 # Number of MCTS simulations per move
...
STOP_COUNT = 5 # How many iterations will be trained before program terminates
...
INITIAL_DATA_SEED = 100 # This controls how many data points are required before first sampling
